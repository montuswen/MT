...
parser.add_argument('--lr_time',type=int,default=5000)
...
if __name__ == '__main__':
    ...
    while True:
        for i_batch, sampled_batch in enumerate(train_loader):
            ...
            loss_seg_dice = get_dice(output_soft[:label_bs, 1, :, :, :], label_batch[:label_bs] == 1)
            ...
            if iter_num % args.lr_time == 0:
                lr_ = base_lr * 0.1 ** (iter_num // args.lr_time)
